...
| Ruta | Contenido |
|---|---|
| `/app/relevamiento` | Dashboard: estado general, CTA único ("Continuar relevamiento" / "Iniciar modo reunión"), grilla de 20 secciones, resumen de hallazgos, próximas decisiones, acciones secundarias |
| `/app/relevamiento/[seccion]` | Runner de una sección: una pregunta (o pequeño grupo) por vez, con tip/why, "modo reunión", notas de Daniel, "no lo sabemos todavía", saltar, guardar y continuar/salir |
...
1. Usar el módulo en la próxima reunión con Gonzalo, en modo reunión.
